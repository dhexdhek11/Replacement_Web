...
Route::get('timetable',[TimetableController::class,'listTimetable'])->middleware('auth');
...
Route::get('admin_timetable/delete/{id}',[AdminTableController::class,'delete'])->middleware('admin');

Route::get('admin_timetable/edit/{id}',[AdminTableController::class,'showData'])->middleware('admin');

Route::post('admin_timetable/edit/{id}',[AdminTableController::class,'update'])->middleware('admin');
...
//Route::get('timetable', [\App\Http\Controllers\ImportExcel\ImportExcelController::class, 'index']);
//Route::post('timetable', [\App\Http\Controllers\ImportExcel\ImportExcelController::class, 'import'])->name('import_timetable');
